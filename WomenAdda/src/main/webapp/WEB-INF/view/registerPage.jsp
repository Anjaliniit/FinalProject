...
<div class="container central">
		...
		<div class="row">
			<div class=col-xs-4><form:label path="zipCode"><spring:message text="ZipCode"/></form:label></div>
			<div class=col-xs-6><form:input path="zipCode"/></div>
			<div class=col-xs-2><form:errors path="zipCode" cssStyle="color: #ff0000;"/></div>
		</div>
		<div class="row">
